...
export default function UsersPage() {
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                const onClick = (e: any) => {
                    e.stopPropagation();
                    const path = "/admin/tracks/" + params.getValue(params.id, "id");
                    navigate(path);
                };
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            const testColumn: keyof Track = sortModel[0].field as any
