...
export default function AlbumsPage() {
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                const onClick = (e: any) => {
                    e.stopPropagation();
                    const path = "/admin/albums/" + params.getValue(params.id, "id");
                    navigate(path);
                };
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            const testColumn: keyof Album = sortModel[0].field as any
    ...
    <div>
    <Fab color="primary" sx={{ position: 'fixed', bottom: 50, right: 50}} aria-label="add" href="/admin/albums/create">
        <AddIcon/>
        </Fab>
        </div>
        </div>
