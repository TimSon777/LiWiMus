...
export default function UsersPage() {
    ...
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            renderCell: (params) => {
                const onClick = (e: any) => {
                    e.stopPropagation();
                    const path = "/admin/playlists/" + params.getValue(params.id, "id");
                    navigate(path);
                };
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            const testColumn: keyof Playlist = sortModel[0].field as any
    ...
    return (
        <div>
            ...
            <div>
                <Fab color="primary" sx={{ position: 'absolute', bottom: 50, right: 50}} aria-label="add" href="/admin/playlists/create">
                    <AddIcon/>
                </Fab>
            </div>
        </div>
