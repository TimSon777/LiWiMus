...
namespace LiWiMus.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220414211627_Identity_Refactoring")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LiWiMus.Core.Artists.Artist", b =>
                {
                    ...
                    b.Property<int>("IdentityAggregateId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("IdentityAggregateId")
                        .IsUnique();
            ...
            modelBuilder.Entity("LiWiMus.Core.IdentityAggregates.IdentityAggregate", b =>
                {
            ...
            modelBuilder.Entity("LiWiMus.Core.Users.User", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_User_Gender_Enum", "`Gender` IN ('Male', 'Female')");
                });

            modelBuilder.Entity("LiWiMus.Infrastructure.Identity.UserIdentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LiWiMus.Core.Artists.Artist", b =>
                {
                    b.HasOne("LiWiMus.Core.IdentityAggregates.IdentityAggregate", "IdentityAggregate")
                        .WithOne("Artist")
                        .HasForeignKey("LiWiMus.Core.Artists.Artist", "IdentityAggregateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("IdentityAggregate");
                });

            modelBuilder.Entity("LiWiMus.Core.Chats.Chat", b =>
                {
                    b.HasOne("LiWiMus.Core.OnlineConsultants.OnlineConsultant", "Consultant")
                        .WithMany("Chats")
            ...
            modelBuilder.Entity("LiWiMus.Core.IdentityAggregates.IdentityAggregate", b =>
                {
                    b.HasOne("LiWiMus.Infrastructure.Identity.UserIdentity", null)
                        .WithOne("Aggregate")
                        .HasForeignKey("LiWiMus.Core.IdentityAggregates.IdentityAggregate", "IdentityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("LiWiMus.Core.LikedUsers.LikedUser", b =>
                {
                    b.HasOne("LiWiMus.Core.Users.User", "Liked")
                        .WithMany("LikedUsers")
            ...
            modelBuilder.Entity("LiWiMus.Core.Messages.Message", b =>
                {
                    ...
                    b.HasOne("LiWiMus.Core.Users.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("LiWiMus.Core.Users.User", b =>
                {
                    b.HasOne("LiWiMus.Core.IdentityAggregates.IdentityAggregate", "IdentityAggregate")
                        .WithOne("User")
                        .HasForeignKey("LiWiMus.Core.Users.User", "IdentityAggregateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
